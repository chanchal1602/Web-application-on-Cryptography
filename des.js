function DESencrypt() {
    //================================================================
    //0- to take plaintext and key from the user
    let DESplain = document.getElementById("PlainText").value;
    let keyword = document.getElementById("KeyWord").value;

    //================================================================
    //1- to split plaintxt into 2 parts:
    document.write("<hr>");
    document.write("<b>Generating plaintext</b><br>");
    document.write("plaintext : "+DESplain);
    let Extendedplain = new Array(DESplain.length);
    document.write("<br>Extended plaintext which is the conversion of plaintext into binary form is:"); 
    document.write("<br>Extended plaintext : ");
    for (let i = 0; i < DESplain.length; i++) {
        ...
        document.write(Extendedplain[i]+" ");
    }
    ...
    var initialpermute = [58, 50, 42, 34, 26, 18, 10,
        ...
        15, 7];
        document.write("<br>initial permute table is:<br>");
        let tempvar=0; 
        ...
        {
            document.write("<tr>");
            for(tempvar=0;tempvar<8;tempvar++,i++)
            {
                document.write("<td>"+initialpermute[i]+"</td>");
            }
            document.write("</tr>");

        }
        document.write("</table>");
    //initialplain is an array which stores 
    ...
    var Permutechoice1 = [57, 49, 41, 33, 25, 17, 9, 1, 58, 50, 42, 34, 26, 18, 10, 2, 59, 51, 43, 35, 27,
        ...
        21, 13, 5, 28, 20, 12, 4];
    document.write("permucation table 1 is:<br>");
    // for(i=0;i<56;i++)
    // {
    //     if(i%7==0 && i!=0)
    //     {
    //         document.write("<br>");
    //         document.write(Permutechoice1[i]+" ");       
    //     }
    //     else
    //     {
    //         document.write(Permutechoice1[i]+" ");
    ...
    tempvar=0; 
        ...
        {
            document.write("<tr>");
            for(tempvar=0;tempvar<7;tempvar++,i++)
            {
                document.write("<td>"+Permutechoice1[i]+"</td>");
            }
            document.write("</tr>");
    ...
    // if(flag==0)
    //  {
            document.write("<br ><table border=1px>");
            document.write("<tr><th>Iteration number</th><th>number to left shift</th></tr>");
            for(i=0,j=1;i<16;i++,j++)
            {
                document.write("<tr><td>"+j+"</td><td>"+Numleftshifts[i]+"</td>");
            }
            document.write("</table>");
            flag=1;
        // }
        document.write("<br>From original pair C0 and D0 we obtain:<br>");
    // loop for 16 rounds:
    do {
        Numleftshifts = [1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1];
        
        let num = 0;
        while (num < Numleftshifts[Round]) 
        {
            document.write("C<sub>"+Round+"</sub>:");
            ...
            document.write("D<sub>"+Round+"</sub>:");

            for (var i = 0; i < 28; i++) {
                // var t1 = Leftpart[0];
                var t2 = Rightpart[0];
                    document.write(Rightpart[i]);
                // Leftpart[i] = Leftpart[i + 1];
                Rightpart[i] = Rightpart[i + 1];
            }
            document.write("<br>");
        ...
        document.write("<br>PC-2 table:<br>");
        let tempvar=0; 
        document.write("<table border=1px>");
        i=0;
        while(i<48)
        {
            document.write("<tr>");
            for(tempvar=0;tempvar<6;tempvar++,i++)
            {
                document.write("<td>"+permutedchoice2[i]+"</td>");
            }
            document.write("</tr>");
